...
public class ManajemenDB extends SQLiteOpenHelper {
    ...
    public final static String NAMADB = "history.db";
    public final static String TABEL_HISTORY = "TabelHistory";
    ...
    public void hapusSemua(String namaTabel) {
        db.execSQL("delete from " + namaTabel);
    }

    @Override
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL(cont.getResources().getString(R.string.TabelHistory));
